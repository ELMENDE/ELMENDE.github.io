...
const T = {
  es: {
    ...
    'experience.job1_b2':    'El proceso completo — descarga, extracción y procesamiento — corre de forma 100% automatizada, eliminando trabajo manual repetitivo a escala.',
    'experience.job1_b3':    'Gestión de incidentes mediante sistema de ticketing, asegurando tiempos de respuesta eficientes ante fallos en el pipeline.',
  ...
  en: {
    ...
    'experience.job1_b2':    'The full pipeline — download, extraction and processing — runs 100% automated, eliminating repetitive manual work at scale.',
    'experience.job1_b3':    'Incident management via ticketing system, ensuring efficient response times when pipeline failures occur.',
...
/* Split hero name into chars preserving the accent span */
